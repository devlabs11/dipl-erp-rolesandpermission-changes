...
class thermaljobcard extends Controller
{
            ...
            if($query_insert==true)
            {
                ...
                if(isset($_POST['job_card_press_ink_details']['ink_quantity']))
                {
                    ...
                    foreach($_POST['job_card_press_ink_details']['ink_quantity'] as $key=>$value) {
                        ...
                        $my_color_id=$_POST['job_card_press_ink_details']['my_color_id'][$key] ?? null;
        ...
        if($edit_id=="0"){
            ...
            if($query_insert==true){
                ...
                echo json_encode(array(
                    ...
                    'url'=>$url,
                    'mode'=>$mode,
                    'post_press_general_details_id'=>$post_press_general_details_id
                ));
            }else{
                $message="Error, While you are trying to insert record.";
                $alert_type="err";
            ...
            if(isset($_POST['packaging_details']['pcs'])){
                foreach($_POST['packaging_details']['pcs'] as $key=>$value) {
                    ...
                    if($packaging_details_id==0 &&  !empty($pcs)){
                        ...
                        $packaging_details_data['height']=$height;
                        $packaging_details_data['units']=$units;
                        $result1 = DB::table("tbl_job_card_post_press_packaging_details")
    ...
    //     $edit_id = $request->input('post_press_edit_id');

    //     $data = [
    //         'job_card_id' => $request->input('post_press_general_details_id'),
    //         'collating_width' => $request->input('collating_width'),
    //         'collating_type' => $request->input('collating_type'),
    //         'collating_between_ply' => implode(',', $request->input('collating_between_ply', [])),
    //         'collating_carbon_option' => $request->input('collating_carbon_option'),
    //         'numbering_position' => $request->input('numbering_position'),
    //         'numbering_style' => $request->input('numbering_style'),
    //         'numbering_skip' => $request->input('numbering_skip'),
    //         'numbering_sequence' => $request->input('numbering_sequence'),
    //         'numbering_orientation' => $request->input('numbering_orientation'),
    //         'gumming_position' => $request->input('gumming_position'),
    //         'gumming_gum_make' => $request->input('gumming_gum_make'),
    //         'gumming_between' => implode(',', $request->input('gumming_between', [])),
    //         'gumming_quantity' => $request->input('gumming_quantity'),
    //         'hotspot_carbon_width' => $request->input('hotspot_carbon_width'),
    //         'hotspot_carbon_height' => $request->input('hotspot_carbon_height'),
    //         'hotspot_carbon_behind_ply_no' => implode(',', $request->input('hotspot_carbon_behind_ply_no', [])),
    //         'cutting_width' => $request->input('cutting_width'),
    //         'cutting_width_unit' => $request->input('cutting_width_unit'),
    //         'cutting_length' => $request->input('cutting_length'),
    //         'cutting_length_unit' => $request->input('cutting_length_unit'),
    //         'cutting_core_size' => $request->input('cutting_core_size'),
    ...
    //         'barcode_orientation' => $request->input('barcode_orientation'),
    //         'barcode_human_readable_text_to_show' => $request->input('barcode_human_readable_text_to_show'),
    //         'baby_roll_making_coating_side' => $request->input('baby_roll_making_coating_side'),
    //     ];
    //     try {
    //     if ($edit_id == "0") {
    //         $insertResult = DB::table('tbl_job_card_post_press')->insert($data);
    //         $mode="add";
    //         $url="";
    //         if ($insertResult) {
    //             $message = "Record inserted successfully.";
    //             $alert_type = "succ";
    //         } else {
    //             $message = "Error, while trying to insert the record.";
    //             $alert_type = "err";
    //         }
    //     } else {
    //         $updateResult = DB::table('tbl_job_card_post_press')
    //                 ->updateOrInsert(
    //                     ['id' => $edit_id],
    //                     $data
    //                 );
    ...
    //         'url'=>$url,
    //         'mode'=>$mode,
    //         'post_press_general_details_id'=>$edit_id
    //     ));
