...
class checkjobcard extends Controller
{
    ...
    public function jobcarddata()
    {
        ...
        if($search_value!="")
        {
            ...
            $tbldata = DB::select("select jc.type as jobtype,jc.id as jobcardid,jc.job_card_title as jobcardtitle,pc.product_category as jobcardproductcategory,tp.product_type as jobcardproducttype from tbl_job_cart jc left join tbl_product_category pc on pc.id=jc.product_category left join tbl_product tp on tp.id=jc.product_type $search_string order by jc.id desc limit $start,$length");
            ...
            if($query_insert==true)
            {
                ...
                if(isset($_POST['paper']['paper_thick']))
                {
                    ...
                    foreach($_POST['paper']['paper_thick'] as $key=>$value) {
                        ...
                        if($paper_thick=="" && $paper_make=="" && $paper_make=="" && $color_shade=="" && $front_side_color=="" && $back_side_color=="" && $front_side_coating=="" && $back_side_coating=="" && $copy_mark=="" && $remark=="")
                        {
                            $part_ply=$part_ply-1;
