<!DOCTYPE html>
@php
    $create = \Helper::getPermission('customer-create') ? 1 : 0;
@endphp
<html lang="en">
	<!--begin::Head-->
	<head>
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    @if ($create == 1)
										...
										<a href="{{ URL::to('customeraddedit/0/general') }}" class="btn btn-sm btn-primary">Add Customer</a>
                                    @else
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												<!--begin::Add customer-->
												<button style="display:none" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Customer</button>
												<!--end::Add customer-->
											</div>
											<!--end::Toolbar-->
											<!--begin::Group actions-->
				...
				function datatablerefresh()
				{
					var table=$('#kt_customers_table').DataTable({
						...
						"columnDefs": [
							...
							{'orderable': true,'searchable': false,'targets': [1],'width':'15%'},
							{'orderable': false,'searchable': false,'targets': [2],'width':'15%'},
							{'orderable': true,'searchable': false,'targets': [3],'width':'25%'},
							{'orderable': true,'searchable': false,'targets': [4],'width':'20%'},
							{'orderable': true,'searchable': false,'targets': [5],'width':'20%'}
						],
						"order": [
							[1, "asc"]
						],
			...
			Swal.fire({
						...
						//denyButtonText: `Don't save`,
							...
							if (result.isConfirmed) {
                                ...
                                url : "{{ URL::to('record_actions_customer') }}",
        						//data : {'token' : 123},
                                success: function (response_json) {
									var response= JSON.parse(response_json);
