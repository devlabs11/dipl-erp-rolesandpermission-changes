                                                    ...
                                                    <div>
                                                        <table cellspacing="0" cellpadding="0" rules="all"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th scope="col">Coating Side</th>
                                                                <th scope="col">Non Coating</th>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo $front_side_coating_name?> <br> <?php echo $front_side_color_name; ?></td>
                                                                <td><?php echo $back_side_coating_name?> <br> <?php echo $back_side_color_name; ?></td>
                                                                {{-- <td align="center">&nbsp;</td> --}}
                                    ...
                                    <td>
                                        <table>
                                            ...
                                            @if (count($post_press) > 0 )
                                                ...
                                                {{-- Cutting --}}
                                                @if ($cutting_width != '' && $cutting_width_unit != '' && $cutting_length != '' && $cutting_length_unit != '' && $cutting_core_size != '')
                                                    <tr>
                                                        <td width="60%" valign="top">
                                                            <span id="Label16" style="font-weight: 700">Cutting :</span>
                                                            <br />
                                                            <span id="Label33">Width  :</span>&nbsp;
                                                            <span id="lblInkLength"><?php echo $cutting_width . ' ' . $cutting_width_unit_name; ?></span>&nbsp;
                                                            {{-- <span id="lblInkLengthUnit">mm</span>&nbsp; --}}
                                                            <span id="Label35">Height  :</span>
                                                            <span id="lblInkWidth"> <?php echo $cutting_length . ' ' . $cutting_length_name; ?></span>&nbsp;
                                                            {{-- <span id="lblInkWidthUnit">mm</span>&nbsp; --}}
                                                            <span id="Label34">Core Size :</span>
                                                            <span id="lblInkThickness"><?php echo $cutting_core_size; ?></span>
                                                            {{-- <span id="lblInkThicknessUnit">mm</span>&nbsp; --}}
                                                        </td>
                                                    </tr>
                                                @endif
                                                ...
                                                {{-- Barcode --}}
                                                @if ($barcode_type != '' && $barcode_height != '' && $barcode_width != '' && $barcode_orientation != '' && $barcode_human_readable_text_to_show != '')
                                                <tr>
                                                    <td width="60%" valign="top">
                                                        <span id="Label16" style="font-weight: 700">Barcode :</span>
                                                        <br />
                                                        <span id="Label33">Type  :</span>&nbsp;
                                                        <span id="lblInkLength"><?php echo $barcode_type; ?></span>&nbsp;
                                                        {{-- <span id="lblInkLengthUnit">mm</span>&nbsp; --}}
                                                        <span id="Label35">Height  :</span>
                                                        <span id="lblInkWidth"> <?php echo $barcode_height;?></span>&nbsp;
                                                        {{-- <span id="lblInkWidthUnit">mm</span>&nbsp; --}}
                                                        <span id="Label34">Width  :</span>
                                                        <span id="lblInkThickness"><?php echo $barcode_width; ?></span>
                                                        {{-- <span id="lblInkThicknessUnit">mm</span>&nbsp; --}}
                                                        <span id="Label34">Orientation   :</span>
                                                        <span id="lblInkThickness">
                                                             @php
                                                                $orientation = DB::table('tbl_orientation')->where('id',$barcode_orientation)->first();
                                                            @endphp
                                                            {{ $orientation->description ?? '' }}</span>
                                                        <span id="Label34">Human Readable   :</span>
                                                        <span id="lblInkThickness"><?php echo $barcode_human_readable_text_to_show; ?></span>
                                                    </td>
                                                </tr>
                                                @endif
                                        ...
                                        <tr>
                                            <td width="60%" valign="top">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <span id="Label9"
                                                                style="font-weight: 700">Print Up Design : </span>&nbsp;&nbsp;&nbsp;&nbsp;<br />
                                                            <br />
                                            ...
                                            <td valign="top" width="40%">
                                                ...
                                                // $row=0;
                                                    ...
                                                    {{-- <tr class="firsttd">
                                                        <td class="firsttd"><span>1</span></td>
                                                    </tr> --}}
                                                </table>
                                            </td>
                                        </tr>
