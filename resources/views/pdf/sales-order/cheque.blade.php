                            ...
                            <table style="width: 100%" border="1">
                                ...
                                <tr>
                                    <td style="width: 50%" valign="top">
                                        <span id="lblCustomerCompany1" style="font-weight: 700">Devharsh Infotech Pvt Ltd  - Bhiwandi Factory</span><br />
                                        <span id="Label1" style="font-weight: 700">Customer Details :</span>
                                        <span id="lblcustomerName">{{ $customer_name_description  ?? ''  }}</span>
                                    </td>
                                    <td style="width: 50%" valign="top">
                                        <span id="Label12" style="font-weight: 700">Sales Order No - </span><span id="lblSalesOrderNo">{{ $order_no  ?? ''  }}</span><br />
                                        <span id="Label15" style="font-weight: 700">SO Date - </span><span id="lblOrderDate">{{ $sales_order_date  ?? ''  }}</span>&nbsp;&nbsp;
                                        <span id="Label13" style="font-weight: 700">Shipment Date - </span><span id="lblShipmentDate">{{ $target_delivery_date  ?? ''  }}</span><br />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="width: 80%">
                            <table cellpadding="2" cellspacing="0" border="0" style="width: 100%">
                                <tr>
                                    <td>
                                        <table cellpadding="0" cellspacing="" style="width: 100%" border="1">
                                            <tr>
                                                <td align="center">
                                                    JC No
                                                </td>
                                ...
                                <tr>
                                    <td style="height: 8px" align="right">
                                        <span id="container" class="red" style="font-size:bold;"></span><span id="lblUOMspan">   {{ $word  ?? '' }} {{  $quantity_unit_name  ?? ''  }}</span>
                                    </td>
                                </tr>
                                <tr valign="top">
                                    <div>
                                                    ...
                                                    <table>
                                                        <tr>
                                                            <td width="60%" valign="top">
                                                                <span id="Label16" style="font-weight: 700">Print Details :-</span>
                                                                <br />
                                                                            ...
                                                                            <div id="DivPerforation">
                                                                                ...
                                                                                <div>
                                                                                    <table style="width: 100%" border="1">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <img src="{{ $image }}" alt="Perforation Details">
                                                                                            </td>
                                                                                        </tr>
                                                                                    </table>
                                                                                </div>
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <fieldset id="Fieldset12" class="repeat" style="width: 750px">
                                                                                    <legend title="Post-Press">Specific Details</legend>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <table style="width: 100%">
                                                                                                    <tr>
                                                                                                        <td style="width: 15%">
                                                                                                            <strong>Tearing</strong><span class="red">*</span>
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <strong>Cutting</strong><span class="red">*</span>
