        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Edit Quotation</h1>
                    <!--end::Title-->
                        ...
                        <div class="card card-flush h-lg-100" id="kt_contacts_main">
                            ...
                            <div class="card-body pt-5">
                                <form class="form">
                                    @method('POST')
                                    @csrf
                                    <input type="hidden" name="id" value="{{ $quotationMaster->id }}" id="quotation_id">
                                                        ...
                                                        <div id="div{{ $key + 1 }}" order-id="{{ $key + 1 }}">
                                                            ...
                                                            <a id="add-more" class="add-more"
                                                                ...
                                                                data-index="{{ $key + 1 }}"><i
                                                                    ...
                                                                    style="color: dodgerblue;"></i>Add More Items</a><br>
                                                ...
                                                <a href="javascript:void(0);" id="add_material" class="waves-effect"><i
                                                        ...
                                                        <div class="card-body pt-5">
                                                            ...
                                                            <input type="hidden" name="title_id" id="title_id"
                                                                value="{{ $quotationMaster->term_title }}">
                                                            <input type="hidden" name="values_id" id="values_id"
                                                                value="{{ $quotationMaster->term_value }}">
                                                            <div class="card-body pt-5">
                                                                <label class="fs-6 fw-bold form-label mt-3">
                                                                    <span class="">Terms and Condition</span>
                                                                </label><br>

                                                                <input hidden type="text" id="storeval" size="100" name="seq_term_title" value="{{ $quotationMaster->term_title }}"/>

                                                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="term"
                                                                    style="width: 50%;">
                                                                    <tbody class="fw-bold text-gray-600">
                                                                        @php
                                                            ...
                                                            <div class="separator mb-6"></div>
                                                            <div class="d-flex justify-content-end">
                                                                <button type="reset" id="cancel_btn" onclick="history.back()"
                                                                    data-kt-contacts-type="cancel" class="btn btn-light me-3">Cancel</button>
        ...
        $(document).ready(function() {
            ...
            $(".form").validate({
                ...
                submitHandler: function() {
                    ...
                    $.ajax({
                        url: "{{ route('quotation-master-update') }}",
                        type: "POST",
