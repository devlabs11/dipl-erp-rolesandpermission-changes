                            ...
                            <form class="form" >
                                ...
                                <div class="col">
                                    <div class="fv-row mb-7">
                                        ...
                                        <input type="text" name="company" id="company" class="form-control form-control-solid">
                                    </div>
                                </div>
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" name="contact_person" id="contact-person" class="form-control form-control-solid">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="number" value="{{old('phone')}}" name="phone" id="phone" class="form-control form-control-solid" maxlength="10">
                                        </div>
                                    </div>
                                </div>
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" name="department" id="department" class="form-control form-control-solid">
                                        </div>
                                    </div>
                                </div>
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" name="designation" id="designation" class="form-control form-control-solid">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" name="quotation_attention" id="quotation_attention" class="form-control form-control-solid">
                                        </div>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        $(".form").validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    url: "{{route('prospect-master-store')}}",
                    type: "POST",
