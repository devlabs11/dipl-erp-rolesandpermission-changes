...
@section('content')
@php
    $create = \Helper::getPermission('prospect-master-create') ? 1 : 0;
    $edit = \Helper::getPermission('prospect-master-edit') ? 1 : 0;
    $delete = \Helper::getPermission('prospect-master-delete') ? 1 : 0;
@endphp
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Prospect Master</h1>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <!--end::Menu-->
                    ...
                    @if ($create == 1)
                        <a href="{{route('prospect-master-create') }}" class="btn btn-sm btn-primary">Add Prospect Master</a>
                    @endif
                        ...
                        <tbody class="fw-bold text-gray-600">
                            @foreach ($pm as $item)
                                <tr>
                                    ...
                                    <td>
                                        @if ($edit == 1)
                                            <a href="{{route('prospect-master-edit',['id' => $item->id])}}" title="Edit" class="menu-link flex-stack px-3" style="font-weight:normal !important;"><i class="fa fa-edit" style="font-weight:normal !important;"></i></a>
                                        @endif
                                        @if ($delete == 1)
                                            <a  onclick="return confirm('Are you sure?')"  href="{{route('prospect-master-destroy',['id' => $item->id])}}" title="Delete" style="cursor: pointer;font-weight:normal !important;" class="menu-link flex-stack px-3"><i class="fa fa-trash" style="color:red;"> </i></a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
