<!DOCTYPE html>
@php
    $create = \Helper::getPermission('old-quotations-create') ? 1 : 0;
@endphp
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<!--end::Menu-->
										...
										<a href="{{ URL::to('quotationaddedit/0') }}" class="btn btn-sm btn-primary">Add Quotation</a>
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												<!--begin::Add customer-->
												<button style="display:none" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Quotation</button>
												<!--end::Add customer-->
											</div>
											<!--end::Toolbar-->
											<!--begin::Group actions-->
				...
				function datatablerefresh()
				{
					...
					var table=$('#kt_customers_table').DataTable({
						...
						"columnDefs": [
							...
							{'orderable': true,'searchable': true,'targets': [2],'width':'15%'},
							{'orderable': true,'searchable': false,'targets': [3],'width':'18%'},
							{'orderable': true,'searchable': false,'targets': [4],'width':'15%'},
							{'orderable': true,'searchable': false,'targets': [5],'width':'17%'},
							{'orderable': true,'searchable': false,'targets': [6],'width':'10%'},
							{'orderable': true,'searchable': false,'targets': [7],'width':'15%'},
			...
			Swal.fire({
						...
						//denyButtonText: `Don't save`,
							...
							if (result.isConfirmed) {
                                ...
                                url : "{{ URL::to('record_actions_quotation') }}",
        						//data : {'token' : 123},
                                success: function (response_json) {
									var response= JSON.parse(response_json);
