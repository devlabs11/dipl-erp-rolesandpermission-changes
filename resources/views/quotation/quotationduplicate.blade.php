											...
											<?php
												...
												if(is_array($tbl_quotation))
												{
													foreach($tbl_quotation as $tbl_quotation)
													{
														...
														$subject=$tbl_quotation->subject." Copy";
											...
											?>
												...
												<div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
													...
													<div class="fv-row mb-7">
															...
															<input type="button" id="generate_tbl"  class="btn btn-primary btn-light me-3" value="Add Table">
														</div>
															<!--end::Input-->
														</div>
														<!--end::Input group-->
												...
												<!--begin::Row-->
												<div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2" id="dvTable">
													<div id="widthtableerror" style="color:red"></div>
												...
												<?php
													...
													if(is_array($quotation_invoice_details))
													{
														...
														<td><a href="javascript:void(0);" class="remove_tbl_row" delete-id="0">Delete</a></td>
														<?php
													}
		...
		$(document).ready(function() 
		{
			...
			frm_user.validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.post("{{ URL::to('duplicatequotation') }}", $("#frm_user").serialize(), function (data) {
