<!DOCTYPE html>
@php
    $create = \Helper::getPermission('rm-product-category-create') ? 1 : 0;
@endphp
<html lang="en">
	<!--begin::Head-->
	<head>
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">RM Product Category</h1>
									<!--end::Title-->
									<!--begin::Separator-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">RM Category</th>
														<th class="min-w-125px">RM Product Category</th>
												...
												<div class="modal-body py-10 px-lg-17">
													...
													<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
														...
														<div class="fv-row mb-7">
															<!--begin::Label-->
															<label class="required fs-6 fw-bold mb-2">Select RM Category Name</label>
															<!--end::Label-->
															<!--begin::Input-->
															<select name="rmcategory" id="rmcategory" aria-label="Select a category" data-control="select2" data-placeholder="Select a category..." data-dropdown-parent="#kt_modal_add_customer" class="form-select form-select-solid fw-bolder">
																<option value="">Select</option>
																<?php

                                                                    $rmcategorydata = DB::select("select * from tbl_rm_category");

																	foreach($rmcategorydata as $rmcategorydata){
                                                                        $name=$rmcategorydata->name;
																		$id=$rmcategorydata->id;
														...
														<!--end::Input group-->
															...
															<div class="fv-row mb-7">
															<!--begin::Label-->
															<label class="required fs-6 fw-bold mb-2">Add Product Category</label>
															<!--end::Label-->
															<!--begin::Input-->
															<input type="text" autocomplete="off" class="form-control form-control-solid" placeholder="Enter Product Category" name="name" id="name" />
															<!--end::Input-->
														</div>
														<!--end::Input group-->
		...
		i=new bootstrap.Modal(document.querySelector("#kt_modal_add_customer"));
				...
				function datatablerefresh()
				{
					var table=$('#kt_customers_table').DataTable({
						...
						processing: true,
						serverSide: true,
						ajax: "{{ URL::to('rmproductcategorydata') }}",
...
{		//populate the textbox
	...
	$.ajax({
				...
				url: "{{ URL::to('editrmproductcategory') }}",
				success: function (response_json) {
					...
					if (response.message==''){
						...
						$('#rmcategory').val(response.rmcategory).trigger('change');
						//$("#country").select2("val",response.country);
					}else{
                        $('#name').val(response.name);
                        // $('#rmcategory').val(response.rmcategory);
						//alert("else part");
			...
			Swal.fire({
						...
						//denyButtonText: `Don't save`,
							...
							if (result.isConfirmed) {
								$.ajax({
							type: "POST",
							url: "{{ URL::to('deletermproductcategory') }}",
							//data: {deleteid:Id},
							data: {
                                    id: Id
                                },
				...
				frmModalForm.validate({
                    ...
                    rules: {
                        name: {
                            required: true,
							remote: {
                                url: "{{ URL::to('validatermproductcategory') }}",
                                type: "post",
                                data: {
                                    id: function () {
                                        return $("#edit_id").val();
                    ...
                    submitHandler: function (form) {
                        ...
                        $.post("{{ URL::to('submitrmproductcategory') }}", $("#create_master").serialize(), function (data) {
