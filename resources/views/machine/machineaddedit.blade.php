...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									{
									?>
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Add New Machine</h1>
									<?php
									}
									else
									{
									?>
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Edit Machine</h1>
									<?php
									}
									?>
									...
									<div class="col-xl-12">
										...
										<div class="card card-flush h-lg-100" id="kt_contacts_main">
											...
											$capacity="";
											  ...
											  if(is_array($tbl_machine))
											  {
												  foreach($tbl_machine as $tbl_machine)
												  {
													  //var_dump($tbl_process);die;
														$id=$tbl_machine->id;
														$unique_id=$tbl_machine->unique_id;
														$machine_name=$tbl_machine->name;
														$category=$tbl_machine->category;
														$spec=$tbl_machine->spec;
														$location=$tbl_machine->location;
														$capacity=$tbl_machine->capacity;
													...
													<div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
														...
														<div class="col">
															...
															<div class="fv-row mb-7">
																...
																<label class="fs-6 fw-bold form-label mt-3">
																	...
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter the unique id."></i>
																</label>
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" name="unique_id" id="unique_id" value="{{$unique_id}}" />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
														</div>
														...
														<div class="col">
															...
															<div class="fv-row mb-7">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" name="machine_name" id="machine_name" value="{{$machine_name}}" />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
														</div>
													...
													<!--end::Row-->
														...
														<div class="col">
															...
															<div class="fv-row mb-7">
																...
																<label class="fs-6 fw-bold form-label mt-3">
																	<span>Spec</span>
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter the spec."></i>
																</label>
																<!--end::Label-->
																<!--begin::Input-->
																<textarea class="form-control form-control-solid" name="spec" id="spec" >{{$spec}}</textarea>
																<!--end::Input-->
															</div>
															<!--end::Input group-->
														</div>
													...
													<div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
														...
														<div class="col">
															...
															<div class="fv-row mb-7">
																...
																<div class="w-100">
																	<div class="form-floating border rounded">
																		<!--begin::Select2-->
																		<select name="location" id="location" aria-label="Select a location" data-control="select2" data-placeholder="Select a location..."  class="form-select form-select-solid lh-1 py-3">
																		<option value="">Select</option>
																		<?php
																			...
																			foreach($sitedata as $sitedata){
																				...
																				echo "<option $selected value='".$site_id."'>$description</option>";
																			}
																		?>
																		</select>
																		<!--end::Select2-->
														...
														<div class="col">
															...
															<div class="fv-row mb-7">
																<!--begin::Label-->
																<label class="fs-6 fw-bold form-label mt-3">
																	<span class="required">Capacity (Forms)</span>
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter the capacity."></i>
																</label>
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" name="capacity" id="capacity" value="{{$capacity}}"  />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
														</div>
														...
														<div class="col">
															...
															<div class="fv-row mb-7">
																...
																<div class="w-100">
																	<div class="form-floating border rounded">
																		<!--begin::Select2-->
																		<select name="status" id="status" aria-label="Select a status" data-control="select2" data-placeholder="Select a status..."  class="form-select form-select-solid lh-1 py-3">
																		    <option value="">Select</option>
		...
		$(document).ready(function() {
			...
			$("#cancel_btn").click(function()
			{
				...
				Swal.fire({
					...
					t.value?(window.location.href = "{{ URL::to('machine') }}"):"cancel"===t.dismiss&&Swal.fire({
		...
		function ajax_submit() {
				...
				var ajax_url = "{{ URL::to('submitmachine') }}";
                $("#lns-error").hide();
                    ...
                    success: function (json) {
						...
						if (data.alert_type == "succ") {
                                if (data.mode=='add'){
									...
									swal.fire({ text: data.message}).then(function(){
														$("#edit_id").val('');
														window.location.href = "{{ URL::to('machine') }}";
													}
													);
