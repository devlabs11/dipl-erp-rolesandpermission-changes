    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Add Sales</h1>
                <!--end::Title-->
            ...
            <div class="row g-7">
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <!--begin::Card body-->
                        <form id="sale-master" class="form" action="{{route('sales-master-store')}}" method="POST" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                <div class="col">
                                    <div class="fv-row mb-7">
                                        ...
                                        <select name="name" id="name" aria-label="Select a Category" data-control="select2" data-placeholder="Select a Category..."  class="form-select form-control form-select-solid lh-1 py-3">
                                            <option value="">Select the slaes Person</option>
                                    ...
                                    <div class="fv-row mb-2">
                                        ...
                                        <div class="w-100">
                                            <div class="form-floating border rounded">
                                                <textarea name="term_value" id="term_value" cols="75" rows="5"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
