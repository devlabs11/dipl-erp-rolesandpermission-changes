...
<body id="kt_body"
                        ...
                        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                            ...
                            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                                ...
                                <?php
									...
									{
									?>
                                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Add New Role</h1>
                                <?php
									}
									else
									{
                                    ...
                                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                                        ...
                                        <div class="card-body pt-5">
											...
											$rolestatus="";
											  ...
											  {
												  foreach($access_roles as $access_roles)
												  {
														$roleid=$access_roles->arid;
														$rolename=$access_roles->rolename;
														$roledescription=$access_roles->description;
														$rolestatus=$access_roles->status;
												  }
											  }
											...
											// 	  {
											// 			$roleid=$resultdata->arid;
											// 			$rolename=$resultdata->rolename;
											// 			$roledescription=$resultdata->description;
											// 			$rolestatus=$resultdata->status;
											// 			$allow_access=$resultdata->allow_access;
											// 			$allow_add=$resultdata->allow_add;
											// 			$allow_view=$resultdata->allow_view;
											// 			$allow_edit=$resultdata->allow_edit;
											// 			$allow_delete=$resultdata->allow_delete;
											// 			$allow_print=$resultdata->allow_print;
											// 			$allow_import=$resultdata->allow_import;
											// 			$allow_export=$resultdata->allow_export;
											// 	  }
											//   }
											...
											?>
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <label class="fs-6 fw-bold form-label mt-3">
                                                                ...
                                                                <i class="fas fa-exclamation-circle ms-1 fs-7"
                                                                    ...
                                                                    title="Enter the role name."></i>
                                                            </label>
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" class="form-control form-control-solid"
                                                                name="rolename" id="rolename" value="{{$rolename}}" />
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                    </div>
                                                            ...
                                                            <div class="w-100">
                                                                <div class="form-floating border rounded">
                                                                    ...
                                                                    <select name="status" id="status"
                                                                        ...
                                                                        <option
                                                                            <?php if($rolestatus=="1"){ echo "selected=selected"; }?>
                                                                            value="1">Active</option>
                                                                        <option
                                                                            <?php if($rolestatus=="0"){ echo "selected=selected"; }?>
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <textarea class="form-control form-control-solid"
                                                                ...
                                                                id="roledescription">{{$roledescription}}</textarea>
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                    </div>
                                                ...
                                                <!--start::Newtree-->
                                                <!-- <input type="text" name="serachrole" id="serachrole"> -->


                                                {{-- <input type="text" id="searchText" class="form-control form-control-solid" style="width:20%;float:right"/>
													<br/>
													<br/>
                                                    <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2" style="margin-bottom:30px" id="tree">
                                                ...
                                                <!-- <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
																...
																<th class="min-w-125px">FULL ACCESS</th>
																<th class="min-w-125px">VIEW</th>
																<th class="min-w-70px">ADD</th>
																<th class="min-w-70px">EDIT</th>
																<th class="min-w-70px">DELETE</th>
																<th class="min-w-70px">PRINT</th>
																<th class="min-w-70px">IMPORT</th>
																<th class="min-w-70px">EXPORT</th>
                                                ...
                                                <div class="d-flex justify-content-end">
                                                    <!--begin::Button-->
                                                    <button type="reset" id="cancel_btn" data-kt-contacts-type="cancel"
    ...
    $.ajax({
        ...
        data: {
            id: <?php echo $id; ?>,
            serachrole: function() {
                return $("#serachrole").val();
            },
        },
        async: false,
        url: "<?= url('/moduledatanew'); ?>",
    ...
    $(document).ready(function() {
        ...
        $("#cancel_btn").click(function() {
            ...
            Swal.fire({
                ...
                t.value ? (window.location.href = "{{ URL::to('role') }}") : "cancel" === t
                    .dismiss && Swal.fire({
        ...
        frm_user.validate({
            ...
            submitHandler: function(form) {
                ...
                $.post("{{ URL::to('submitrole') }}", $("#frm_user").serialize(), function(data) {
