<!DOCTYPE html>
@php
    $create = \Helper::getPermission('role-create') ? 1 : 0;
@endphp
<html lang="en">
	<!--begin::Head-->
	<head>
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<a href="{{ URL::to('roleaddedit/0') }}" class="btn btn-sm btn-primary">Add Role</a>
                                    @else
			...
			Swal.fire({
						...
						//denyButtonText: `Don't save`,
							...
							if (result.isConfirmed) {
                                ...
                                url : "{{ URL::to('record_actions_role') }}",
        						//data : {'token' : 123},
