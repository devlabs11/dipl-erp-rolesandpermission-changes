						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Material</h1>
									<!--end::Title-->
									<!--begin::Separator-->
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<div class="me-0" style="display:none">
                                        ...
                                        @if ($create ==1)
                                            <a href="{{ URL::to('materialaddedit/0') }}" class="btn btn-sm btn-primary">Add Material</a>
                                        @else
			...
			Swal.fire({
						...
						//denyButtonText: `Don't save`,
							...
							if (result.isConfirmed) {
                                ...
                                url : "{{ URL::to('record_actions_material') }}",
        						//data : {'token' : 123},
                                success: function (response_json) {
									var response= JSON.parse(response_json);
