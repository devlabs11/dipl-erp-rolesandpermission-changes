			...
			if($job_card_paper_count!=0)
			{
				...
				<th
                   ...
                   Paper Size</th>
					...
					<th style="text-align:left;border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">Coating Color</th>
					<th style="text-align:left;border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">Non Coating Color</th>
					<th style="text-align:left;border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">Coating Side</th>
					<th style="text-align:left;border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">Non Coating Side</th>
...
<h2><center><u>Process Selection</u></center></h2><br/>
