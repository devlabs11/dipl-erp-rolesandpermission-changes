 ...
 <!-- Define header and footer blocks before your content -->
		...
		<main>
			...
			if($job_card_paper_count!=0)
			{
				...
				<table id='maintable' style='width:100%;border: 1px solid black;border-collapse: collapse;padding-top:15px;'>
				<tr>
				...
				<th
                   ...
                   Paper Size</th>
					...
					<th style=" overflow-wrap: break-word;text-align:left;border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">Front Colors</th>
					<th style=" overflow-wrap: break-word;text-align:left;border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">Back Colors</th>
				...
				foreach($tbl_job_card_paper as $tbl_job_card_paper)
				{
					...
					<tr>
						...
						<td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">{{$paper_width}} {{$paper_unit_name}}</td>
						...
						<td style=" overflow-wrap: break-word;border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;"><?php echo $front_side_color_name; ?></td>
						<td style=" overflow-wrap: break-word;border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;"><?php echo $back_side_color_name; ?></td>
...
{
?>
<h2><center><u>Press Details</u></center></h2><br/>
...
<h2><center><u>Material Requirement</u></center></h2><br/>
