...
@section('content')
@php
    $create = \Helper::getPermission('process-category-create') ? 1 : 0;
    $edit = \Helper::getPermission('process-category-edit') ? 1 : 0;
    $delete = \Helper::getPermission('process-category-delete') ? 1 : 0;
@endphp
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Process Category</h1>
                <!--end::Title-->
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Add Process Category</h3>
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                                @foreach ($processCategory as $item)
                                    <tr>
...
<script>
    $( document ).ready(function() {
        console.log("Process Category master-index File!" );
        ...
        $('.delete').click(function(e){
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{route('process-category-destroy')}}",
                    type: "GET",
                    data: {'id':id},
                        ...
                        if(response == 1){
                            Swal.fire(
                                ...
                                'success'
                                    ...
                                    window.location = "{{route('process-category')}}";
                                }
                            )
                        }else{
                            swal.fire({
        ...
        $('#save_data').click(function(e){
            ...
            var url = data = "";
            if(id){
                $('.modal-title h3').text('Edit Process Category');
                url = "{{route('process-category-update')}}";
                data = {
                        'id': id,
                        'name': typeName
                    };
            }else{
                $('.modal-title h3').text('Add Process Category');
                url = "{{route('process-category-store')}}";
                data = {
                    'name': typeName
                };
            }
            if(typeName.length === 0) {
                Swal.fire('Please Enter Process Category');
            }
            $.ajax({
                url: url,
                type: "POST",
                ...
                success: function( response ) {
                    ...
                    if(response == 1){
                        ...
                        swal.fire({
                            title: "Duplicate Process Category Name",
                            text: "Please check",
                            type: "info"
                        });
                    }else{
        ...
        $('.edit').click(function(e){
            ...
            console.log('edit: '+id);
            $('.modal-title').html('Edit Process Category');
