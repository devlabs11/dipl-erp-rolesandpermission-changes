<!DOCTYPE html>
@php
    $create = \Helper::getPermission('sm-category-create') ? 1 : 0;
@endphp
<html lang="en">
	<!--begin::Head-->
	<head>
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Manage Spare Parts</h1>
									<!--end::Title-->
									<!--begin::Separator-->
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<!--begin::Add customer-->
                                    @if ($create == 1)
									    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Spare</button>
									<!--end::Add customer-->
                                    @else
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												<!--begin::Add customer-->
												<button style="display:none" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Spare</button>
												<!--end::Add customer-->
											</div>
											<!--end::Toolbar-->
											<!--begin::Group actions-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">Spare Parts Name</th>
										...
										<div class="modal-content">
											...
											<form class="form"  name="create_master" onsubmit="return false;" id="create_master">
												...
												<div class="modal-header" id="kt_modal_add_customer_header">
													<!--begin::Modal title-->
													<h2 class="fw-bolder"><p style="display:inline" id="titleid">Add</p> Spare</h2>
													<!--end::Modal title-->
													<!--begin::Close-->
												...
												<div class="modal-body py-10 px-lg-17">
													...
													<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
														...
														<div class="fv-row mb-7">
															<!--begin::Label-->
															<label class="required fs-6 fw-bold mb-2">Spare Part Name</label>
															<!--end::Label-->
															<!--begin::Input-->
															<input type="text" autocomplete="off" class="form-control form-control-solid" placeholder="" name="sparename" id="sparename" />
															<!--end::Input-->
														</div>
														<!--end::Input group-->
														...
														<!--end::Label-->
														<!--begin::Input-->
														<select name="unit" id="unit" aria-label="Select a unit" data-control="select2" data-placeholder="Select a unit..." data-dropdown-parent="#kt_modal_add_customer" class="form-select form-select-solid fw-bolder">
															<option value="">Select</option>
															<?php
																$unitdata = DB::select("select * from mst_unit");
														...
														<!--end::Label-->
														<!--begin::Input-->
														<select name="type" id="type" aria-label="Select a type" data-control="select2" data-placeholder="Select a type..." data-dropdown-parent="#kt_modal_add_customer" class="form-select form-select-solid fw-bolder">
															<option value="">Select</option>
...
{		//populate the textbox
	...
	$.ajax({
				...
				url: "{{ URL::to('editspare') }}",
				success: function (response_json) {
					var response= JSON.parse(response_json);
					//alert(response.message);
					if (response.message==''){
						//alert("here");
						$('#sparename').val(response.name);
						...
						// if(response.type=="0")
						// {
						// 	type_description="Refundable";
						// }
						// else
						// {
						// 	type_description="Non-Refundable";
						// }

						//$("#type").select2('data', { id:response.type, text: response.type_description});

						$("#unit").select2('data', { id:response.unit, text: response.unitdescription});
			...
			Swal.fire({
						...
						//denyButtonText: `Don't save`,
							...
							if (result.isConfirmed) {
                                ...
                                url : "{{ URL::to('record_actions_spare') }}",
        						//data : {'token' : 123},
                                success: function (response_json) {
									var response= JSON.parse(response_json);
			...
			$(document).ready(function() {
				...
				frmModalForm.validate({
                    ...
                    submitHandler: function (form) {
                        ...
                        $.post("{{ URL::to('submitspare') }}", $("#create_master").serialize(), function (data) {
