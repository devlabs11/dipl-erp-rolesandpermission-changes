        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">
                    @if ($productSizeMaster)
                        Edit
                    @else
                        Add
                    @endif  Product Size Master
                </h1>
                <!--end::Title-->
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-body pt-5">
                            <form class="form" data-id="@isset($productSizeMaster){{ $productSizeMaster->id }}@endisset">
                                @method('POST')
                                @csrf
                                <input type="hidden" name="id" value="@isset($productSizeMaster){{ $productSizeMaster->id }}@endisset">
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                        ...
                                        <div class="fv-row mb-4">
                                            ...
                                            <select name="product_category_id" id="product_category_id" aria-label="Select" data-control="select2" data-placeholder="Select"  class="form-select form-select-solid lh-1 py-3">
                                                ...
                                                @foreach ($productCategories as $category)
                                                    <option value="{{$category->id}}" @isset($productSizeMaster)
                                                        @if ($productSizeMaster->product_category_id == $category->id)
                                                         selected
                                                        @endif
                                                    @endisset>
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <select name="product_id" id="product_id" aria-label="Select" data-control="select2" data-placeholder="Select"  class="form-select form-select-solid lh-1 py-3">
                                                <option value="">Select</option>
                                                @foreach ($products as $product)
                                                    <option value="{{$product->id}}"
                                                        @isset($productSizeMaster)
                                                            @if ($productSizeMaster->product_id == $product->id)
                                                                selected
                                                             @endif
                                                        @endisset>
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" name="item_code" id="item_code" class="form-control form-control-solid" value="{{ old('item_code', $productSizeMaster->item_code ?? '') }}">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" name="product_size" id="product_size" class="form-control form-control-solid" value="{{ old('product_size', $productSizeMaster->product_size ?? '') }}">
                                        </div>
                                    </div>
                                </div>
