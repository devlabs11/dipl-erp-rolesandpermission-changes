            ...
            <div style="min-width: 600px">
                <main>
                    <div class="row contacts">
                        ...
                        <div>The {{ $weeklyRecords ? $weeklyRecords->count() : 0 }} Sales Contract were generated on {{ date('d-m-Y', strtotime($startDate)) }} - {{ date('d-m-Y', strtotime($endDate)) }}.</div>
                    ...
                    <table style='border: 1px solid black;border-collapse: collapse;width:80% !important;min-width:80% !important;' >
                        ...
                        <tbody>
                            @if ($weeklyRecords->count() > 0)
                                @foreach ($weeklyRecords as $salesContract)
                                <tr>
