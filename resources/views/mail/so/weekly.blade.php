            ...
            <div style="min-width: 600px">
                <main>
                    <div class="row contacts">
                        ...
                        <div>The {{ $weeklyRecords ? $weeklyRecords->count() : 0 }} Sales Work Order were generated on {{ date('d-m-Y', strtotime($startDate)) }} - {{ date('d-m-Y', strtotime($endDate)) }}.</div>
