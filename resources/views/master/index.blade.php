...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
                                    ...
                                    @if ($create)
                                        	<!--begin::Add customer-->
                                            <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add {{$title}}</button>
                                            <!--end::Add customer-->
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												<!--begin::Add customer-->
												<button style="display:none" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add {{$title}}</button>
												<!--end::Add customer-->
											</div>
											<!--end::Toolbar-->
											<!--begin::Group actions-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
														...
														<?php
														if($tblid!="1" && $tblid!="6"  && $tblid!="7" && $tblid!="8" && $tblid!="9" && $tblid!="10" && $tblid!="11")
														{
															if($tblid=="2")
															{
																?>
										...
										<div class="modal-content">
											...
											<form class="form"  name="create_master" onsubmit="return false;" id="create_master">
												...
												<div class="modal-header" id="kt_modal_add_customer_header">
													<!--begin::Modal title-->
													<h2 class="fw-bolder"><p style="display:inline" id="titleid">Add</p> {{$title}}</h2>
													<!--end::Modal title-->
													<!--begin::Close-->
													...
													<?php
														...
														?>
															...
															<div class="fv-row mb-7">
																...
																<!--begin::Input-->
																<select name="company" id="company" aria-label="Select a company" data-control="select2" data-placeholder="Select a company..." data-dropdown-parent="#kt_modal_add_customer" class="form-select form-select-solid fw-bolder">
																	<option value="">Select</option>
																	<?php
																		$countrydata = DB::select("select * from tbl_company");
														...
														<div class="fv-row mb-7">
															<!--begin::Label-->
															<label class="required fs-6 fw-bold mb-2">{{$title}} Code</label>
															<!--end::Label-->
															<!--begin::Input-->
														...
														<div class="fv-row mb-7" style="display:none">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input type="text" autocomplete="off" class="form-control form-control-solid" placeholder="" name="code" id="code" value="val" />
															<!--end::Input-->
														</div>
														<!--end::Input group-->
														<?php
														...
														<div class="fv-row mb-7">
															...
															{
																?>
																<label class="required fs-6 fw-bold mb-2">Location Name</label>
																<?php
															}
															else
															{
																?>
																<label class="required fs-6 fw-bold mb-2">{{$title}} Name</label>
																<?php
															}
															?>
														...
														<div class="fv-row mb-7">
															...
															<!--end::Label-->
															<!--begin::Input-->
															<textarea autocomplete="off" class="form-control form-control-solid" placeholder="" name="address" id="address" ></textarea>
															<!--end::Input-->
														</div>
														<!--end::Input group-->
														<?php
														...
														else
														{
															...
															<div class="fv-row mb-7" style="display:none">
																...
																<!--end::Label-->
																<!--begin::Input-->
																<textarea autocomplete="off" class="form-control form-control-solid" placeholder="" name="address" id="address" >Address</textarea>
																<!--end::Input-->
															</div>
															<!--end::Input group-->
															<?php
														...
														<!--begin::Billing form-->
														<div id="kt_modal_add_customer_billing_info" class="collapse show" style="display:none">
		...
		i=new bootstrap.Modal(document.querySelector("#kt_modal_add_customer"));
				...
				col_desc="{'orderable': false,'searchable': false,'targets': [0],'width':'5%'},";
				col_desc+="{'orderable': false,'searchable': false,'targets': [1],'width':'5%'},";
				col_desc+="{'orderable': true,'searchable': false,'targets': [2],'width':'5%'},";
				col_desc+= "{'orderable': true,'searchable': false,'targets': [3],'width':'15%'},";
				col_desc+= "{'orderable': true,'searchable': false,'targets': [4],'width':'15%'}, ";
				<?php
				}
				else if($tblid=="1")
				{
				...
				else if($tblid=="6" || $tblid=="7" || $tblid=="8" || $tblid=="9" || $tblid=="10" || $tblid=="11")
				{
				?>
				...
				{
				?>
				var col_desc="{'orderable': true,'searchable': false,'targets': [0],'width':'5%'},{'orderable': true,'searchable': true,'targets': [1]}, {'orderable': true,'searchable': false,'targets': [2],'width':'15%'}, {'orderable': true,'searchable': false,'targets': [3],'width':'15%'}, ";
				<?php
				}
				?>
				...
				function datatablerefresh()
				{
					var table=$('#kt_customers_table').DataTable({
						...
						serverSide: true,
						ajax: {
							 		url: "{{ URL::to('data') }}"+"/{{$tblid}}",
						            type: 'POST',
						            data : {_token:"{{ csrf_token() }}"}
						},
						//ajax: "{{ URL::to('data') }}"+"/{{$tblid}}",
						// columns: [
						// { data: 'id', name: 'id' },
...
{
	$("#titleid").text("Add");
	var my_tbl_id="<?php echo $tblid; ?>";

	if(my_tbl_id=="1" || my_tbl_id=="6" || my_tbl_id=="7" || my_tbl_id=="8" || my_tbl_id=="9" || my_tbl_id=="10" || my_tbl_id=="11")
	{
		//alert("here 11");
	...
	else if(my_tbl_id=="3" || my_tbl_id=="4")
	{
		$('#company').val('0').trigger('change');
		$("#company-error").html('');
	}
...
{		//populate the textbox
	...
	$.ajax({
				type: "POST",
				data: "edit_id="+edit_id+"&tbl={{$tbl}}"+"&id={{$tblid}}",
				url: "{{ URL::to('editmaster') }}",
			...
			Swal.fire({
						...
						//denyButtonText: `Don't save`,
							...
							if (result.isConfirmed) {
								$.ajax({
                                type: "POST",
                                data: $('#master_frm').serialize()+ "&opt="+opt+"&tbl={{$tbl}}"+"&id="+{{$tblid}},
                                url : "{{ URL::to('record_actions') }}",
        						//data : {'token' : 123},
                                success: function (response_json) {
									var response= JSON.parse(response_json);
			...
			$(document).ready(function() {
				...
				frmModalForm.validate({
                    ...
                    submitHandler: function (form) {
						...
						//alert("here");
						//alert("here");
						//alert("<?php echo $tblid; ?>");

                        $.post("{{ URL::to('submitmaster') }}", $("#create_master").serialize()+"&id="+{{$tblid}}, function (data) {
							...
							if (data.alert_type == "succ") {
                                ...
                                if (data.mode=='add'){
									...
									swal.fire({ text: data.message, type:
                    ...
                    messages: {
                        name: {
                            ...
                            remote: "This {{$title}} already exists. Please try another {{$title}}.",
                        },
