						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Product Category</h1>
									<!--end::Title-->
									<!--begin::Separator-->
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<!--begin::Add customer-->
                                    @if ($create == 1)
									    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Product Category</button>
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												<!--begin::Add customer-->
												<button style="display:none" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Product Category</button>
												<!--end::Add customer-->
											</div>
											<!--end::Toolbar-->
											<!--begin::Group actions-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">HSN Code</th>
										...
										<div class="modal-content">
											...
											<form class="form"  name="create_master" onsubmit="return false;" id="create_master">
												...
												<div class="modal-header" id="kt_modal_add_customer_header">
													<!--begin::Modal title-->
													<h2 class="fw-bolder"><p style="display:inline" id="titleid">Add</p> Product Category</h2>
													<!--end::Modal title-->
													<!--begin::Close-->
												...
												<div class="modal-body py-10 px-lg-17">
													...
													<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
														...
														<div class="fv-row mb-7">
															<!--begin::Label-->
															<label class="required fs-6 fw-bold mb-2">Product Category</label>
															<!--end::Label-->
															<!--begin::Input-->
															<input type="text" autocomplete="off" class="form-control form-control-solid" placeholder="" name="product_category" id="product_category" />
															<!--end::Input-->
														</div>
														<!--end::Input group-->
														...
														<div class="fv-row mb-7">
														<!--begin::Label-->
														<label class="required fs-6 fw-bold mb-2">HSN Code</label>
														<!--end::Label-->
														<!--begin::Input-->
														<input type="text" autocomplete="off" class="form-control form-control-solid" placeholder="" name="hs_code" id="hs_code" />
														<!--end::Input-->
														</div>
														<!--end::Input group-->
														...
														<div class="fv-row mb-7">
														<!--begin::Label-->
														{{-- <label class="fs-6 fw-bold mb-2">Excise Code</label> --}}
														<!--end::Label-->
														<!--begin::Input-->
														{{-- <select name="excise_code" id="excise_code" aria-label="Select a excise code" data-control="select2" data-placeholder="Select a excise code..." data-dropdown-parent="#kt_modal_add_customer" class="form-select form-select-solid fw-bolder">
															<option value="">Select</option>
															<?php
																$excise_data = DB::select("select * from tbl_excise");

																foreach($excise_data as $excise_data){
																	$excise_code=$excise_data->excise_code;
																	$excise_id=$excise_data->id;
																	echo "<option value='".$excise_id."'>$excise_code</option>";
																}
															?>
														</select> --}}
														<!--end::Input-->
														...
														<div class="fv-row mb-7">
														<!--begin::Label-->
														{{-- <label class="fs-6 fw-bold mb-2">Excise Description</label> --}}
														<!--end::Label-->
														<!--begin::Input-->
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            <!--begin::Label-->
                                                            <label class="fs-6 fw-bold mb-2">SAC</label>
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <input type="text" autocomplete="off" class="form-control form-control-solid" placeholder="" name="sac" id="sac" />
                                                            <!--end::Input-->
                                                        </div>
														...
														<div class="fv-row mb-7">
                                                            <!--begin::Label-->
                                                            <label class="fs-6 fw-bold mb-2">Job Card Type</label>
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <select name="job_card_type" id="job_card_type" aria-label="Select a Job Card Type" data-control="select2" data-placeholder="Select a Job Card Type..." data-dropdown-parent="#kt_modal_add_customer" class="form-select form-select-solid fw-bolder">
                                                                <option value="">Select</option>
                                                                @php
                                                                    $jobCardTypes = DB::table('job_card_types')->get();
                                                                @endphp
                                                                @foreach ($jobCardTypes as $jobCardType)
                                                                    <option value="{{ $jobCardType->id }}">{{ $jobCardType->name }}</option>
                                                                @endforeach
                                                            </select>
                                                            <!--end::Input-->
                                                        </div>
		...
		i=new bootstrap.Modal(document.querySelector("#kt_modal_add_customer"));
				...
				function datatablerefresh()
				{
					var table=$('#kt_customers_table').DataTable({
						...
						"pageLength": 15,
						serverSide: true,
						ajax: "{{ URL::to('productcategorydata') }}",
						"scrollX": true,
						"columnDefs": [
							...
							// {'orderable': true,'searchable': false,'targets': [5],'width':'15%'},
							// {'orderable': true,'searchable': false,'targets': [6],'width':'15%'},
						],
						"order": [
							[1, "asc"]
						],
...
{		//populate the textbox
	...
	$.ajax({
				...
				url: "{{ URL::to('editproductcategory') }}",
				success: function (response_json) {
					...
					if (response.message==''){
                        ...
                        $('#sac').val(response.sac);
						$('#job_card_type').val(response.job_card_type_id);
                        $('#job_card_type').select2('refresh')
                        $('#job_card_type').select2().trigger(response.job_card_type_id);

						//$("#excise_code").select2('data', { id:response.excise_code, text: response.excise_code_name});
						//$('#excise_code').val(response.state).trigger('change');
                        // $("#excise_code").select2("trigger", "select", {
                        //         data: { id: response.excise_code,text:response.excise_code_name}
                        // });
	...
	//alert("edit id else part");
			...
			Swal.fire({
						...
						//denyButtonText: `Don't save`,
							...
							if (result.isConfirmed) {
                                ...
                                url : "{{ URL::to('record_actions_productcategory') }}",
        						//data : {'token' : 123},
                                success: function (response_json) {
									var response= JSON.parse(response_json);
			...
			Swal.fire({
						...
						//denyButtonText: `Don't save`,
							...
							if (result.isConfirmed) {
								$.ajax({
							type: "POST",
							url: "{{ URL::to('deleteproductcategory') }}",
							//data: {deleteid:Id},
							data: {
                                    id: Id
                                },
		...
		function getCheckCount()
		{
			...
			$(document).ready(function() {
				...
				$('#excise_code').change(function() {
					var item=$(this);
					//alert(item.val());

					$.ajax({
								type: "POST",
								data: "excise_code_id="+item.val(),
								url: "{{ URL::to('get_excise_code_description') }}",
								success: function (response_json) {
									var response= JSON.parse(response_json);
									//alert(response.excise_description);
									$('#excise_description').val(response.excise_description);
								}
							});
				});
				...
				frmModalForm.validate({
                    ...
                    rules: {
                        product_category: {
                            required: true,
							/*remote: {
                                url: "{{ URL::to('validateproductcategory') }}",
                                type: "post",
                                data: {
                                    id: function () {
                                        return $("#edit_id").val();
                    ...
                    submitHandler: function (form) {
                        ...
                        $.post("{{ URL::to('submitproductcategory') }}", $("#create_master").serialize(), function (data) {
		...
		$('#kt_modal_add_customer').on('hidden.bs.modal', function ()
		{
			...
			$("#product_category-error").html('');
			$("#hs_code-error").html('');
			//$("#country").select2("val","0");
			$('#excise_code').val('').trigger('change');
			//$('#state').val('').trigger('change');
			// $('#status').val('').trigger('change');
			// $("#status-error").html('');
			$("#excise_code-error").html('');
			$("#excise_description").html('');
		})
