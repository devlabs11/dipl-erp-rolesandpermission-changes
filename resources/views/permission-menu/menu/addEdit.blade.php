        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">
                    @isset($permissionMenuMaster)
                        Edit
                    @endisset
                    @empty($permissionMenuMaster)
                        Add
                    @endempty
                     Menu
                </h1>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-body pt-5">
                            <form class="form" data-id="@isset($permissionMenuMaster) {{ $permissionMenuMaster->id}}@endisset">
                                @method('POST')
                                @csrf
                                <input type="hidden" name="id" value="@isset($permissionMenuMaster)
                                {{ $permissionMenuMaster->id}}
                                @endisset">
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-3">
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" name="title" id="title" value="@isset($permissionMenuMaster){{$permissionMenuMaster->title ?? ''}}@endisset"  class="form-control form-control-solid">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" name="url" id="url" value="@isset($permissionMenuMaster){{$permissionMenuMaster->url ?? ''}}@endisset" class="form-control form-control-solid">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" name="icon" id="icon" value="@isset($permissionMenuMaster){{$permissionMenuMaster->icon ?? ''}}@endisset"  class="form-control form-control-solid">
                                        </div>
                                    </div>
                                </div>
