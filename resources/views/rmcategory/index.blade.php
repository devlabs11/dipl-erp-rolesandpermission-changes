<!DOCTYPE html>
@php
    $create = \Helper::getPermission('rm-category-create') ? 1 : 0;
@endphp
<html lang="en">
	<!--begin::Head-->
	<head>
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Raw Material Category</h1>
									<!--end::Title-->
									<!--begin::Separator-->
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<!--begin::Add customer-->
                                    @if ($create == 1)
									    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Raw Material Category</button>
                                    @else
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												<!--begin::Add customer-->
												<button style="display:none" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Raw Material Category</button>
												<!--end::Add customer-->
											</div>
											<!--end::Toolbar-->
											<!--begin::Group actions-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">Raw Material Category</th>
										...
										<div class="modal-content">
											...
											<form class="form"  name="create_master" onsubmit="return false;" id="create_master">
												...
												<div class="modal-header" id="kt_modal_add_customer_header">
													<!--begin::Modal title-->
													<h2 class="fw-bolder"><p style="display:inline" id="titleid">Add</p> Raw Material Category</h2>
													<!--end::Modal title-->
													<!--begin::Close-->
												...
												<div class="modal-body py-10 px-lg-17">
													...
													<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
														...
														<div class="fv-row mb-7">
															<!--begin::Label-->
															<label class="required fs-6 fw-bold mb-2">Enter Category</label>
															<!--end::Label-->
															<!--begin::Input-->
		...
		Swal.fire({
						...
						//denyButtonText: `Don't save`,
							...
							if (result.isConfirmed) {
                                ...
                                url : "{{ URL::to('record_actions_rm_category') }}",
                                success: function (response_json) {
									var response= JSON.parse(response_json);
		...
		function LoadDeleteDialog(Id){
			...
			Swal.fire({
						...
						confirmButtonText: `Save`,
							...
							if (result.isConfirmed) {
                            // call to funtion delete
							$.ajax({
							type: "POST",
							url: "{{ URL::to('deletermcategory') }}",
							data: {
                                    id: Id
                                },
							success: function (response_json) {
				...
				frmModalForm.validate({
                    ...
                    rules: {
                        code: {
                            required: true,
							remote: {
                                url: "{{ URL::to('validatermcategorycode') }}",
                                type: "post",
                                data: {
                                    id: function () {
                                        return $("#edit_id").val();
                    ...
                    $.post("{{ URL::to('submitrmcategory') }}", $("#create_master").serialize(), function (data) {
                    ...
                    messages: {
                        name: {
                            ...
                            remote: "This category already exists. Please try another category.",
                        }
                    }
                });
