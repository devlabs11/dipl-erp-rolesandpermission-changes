...
<body style="font-family:'Helvetica';font-size: 11.25pt;">
 <!-- Define header and footer blocks before your content -->
		...
		<main>
            ...
            @if (!empty($product_category_name) && !empty($product_type_name) && !empty($job_card_no) && !empty($job_card_title) && !empty($general_width) && !empty($general_height_length) && !empty($part_ply) && !empty($job_card_title))
            ...
            @else
                 @if (!empty($product_category_name) || !empty($product_type_name) || !empty($job_card_no) || !empty($job_card_title) || !empty($general_width) || !empty($general_height_length) || !empty($part_ply) || !empty($job_card_title))
                    ...
                    @if (!empty($general_width) || !empty($general_height_length) || !empty($part_ply) || !empty($job_card_title))
                        <b><h3><?php echo "Size"; ?></h3></b>
                    @endif
                    ...
                    @if (!empty($part_ply))
                        <b><?php echo "Part Ply :" ?></b><?php echo $part_ply; ?></b><br/><br/><b><?php echo "Part Ply :" ?></b><?php echo $part_ply; ?></b><br/><br/>
                    @endif
			...
			if(count($tbl_job_card_paper_count)>0)
			{
				...
				<th style="text-align:left;border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">Paper Size</th>
