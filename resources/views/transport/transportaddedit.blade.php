...
<html lang="en">
	...
	<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed toolbar-enabled toolbar-fixed aside-enabled aside-fixed" style="--kt-toolbar-height:55px;--kt-toolbar-height-tablet-and-mobile:55px">
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									{
									?>
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Add New Transport</h1>
									<?php
									}
									else
									{
									?>
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Edit Transport</h1>
									<?php
									}
									?>
								...
								<div class="row g-7">
									...
									<div class="col-xl-12">
										...
										<div class="card card-flush h-lg-100" id="kt_contacts_main">
											...
											$transport_add="";
											$transport_location="";
											$transport_location_arr =array();

											  if(is_array($tbl_transport))
											  {
												  foreach($tbl_transport as $tbl_transport)
												  {
													  //var_dump($tbl_process);die;
														...
														$transport_phone_no=$tbl_transport->transport_phone_no;
														$transport_add=$tbl_transport->transport_add;
														$transport_location=$tbl_transport->transport_location;
														$transport_location_arr = explode(",",$transport_location);
													...
													<div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
														...
														<div class="col">
															...
															<div class="fv-row mb-7">
																...
																<label class="fs-6 fw-bold form-label mt-3">
																	<span class="required">Transporter Name</span>
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter the Transporter Name."></i>
																</label>
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" name="transport_name" id="transport_name" value="{{$transport_name}}" />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
														</div>
														...
														<div class="col">
															...
															<div class="fv-row mb-7">
																<!--begin::Label-->
																<label class="fs-6 fw-bold form-label mt-3">
																	<span class="required">Transporter Phone No.</span>
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter the Transporter Phone No.."></i>
																</label>
																<!--end::Label-->
																<!--begin::Input-->
																<input type="text" class="form-control form-control-solid" name="transport_phone_no" id="transport_phone_no" value="{{$transport_phone_no}}" />
																<!--end::Input-->
															</div>
															<!--end::Input group-->
														</div>
													...
													<div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
														...
														<div class="col">
															...
															<div class="fv-row mb-7">
																<!--begin::Label-->
																<label class="fs-6 fw-bold form-label mt-3">
																	<span >Transporter Add.</span>
																	<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter Transporter Add."></i>
																</label>
																<!--end::Label-->
																<!--begin::Input-->

																
																<textarea class='form-control form-control-solid' name="transport_add" ><?php echo $transport_add; ?></textarea>
																<!--end::Input-->
															</div>
															<!--end::Input group-->
														</div>
														...
														<div class="col" style="width:30% !important;" id="taxes_div">
															...
															<div class="fv-row mb-4">
																	...
																	<label class="fs-6 fw-bold form-label mt-3">
																		...
																		<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Select Location."></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																		<button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Location</button>
																	</label>
																	<!--end::Label-->
																	<div class="w-100">
																		...
																		<div class="form-floating border rounded">
																			<!--begin::Select2-->
																			<select  multiple name="transport_location[]" id="taxes" aria-label="Select Location" data-control="select2" data-placeholder="Select Location..."  class="form-select form-select-solid lh-1 py-3">
																				...
																				<?php
																					...
																					foreach($tbl_transport_location as $tbl_transport_location){
																						...
																						$id=$tbl_transport_location->id;
																						$selected="";


																						if(in_array("$id", $transport_location_arr))
																						{
																							$selected="selected='selected'";
																						}
																						
																						echo "<option $selected value='".$id."'>$location_name</option>";
																					}
																				?>
																			</select>
																			<!--end::Select2-->
										...
										<div class="modal-content">
											...
											<form class="form"  name="create_master" onsubmit="return false;" id="create_master">
												...
												<div class="modal-header" id="kt_modal_add_customer_header">
													<!--begin::Modal title-->
													<h2 class="fw-bolder"><p style="display:inline" id="titleid">Add</p> Location</h2>
													<!--end::Modal title-->
													<!--begin::Close-->
												...
												<div class="modal-body py-10 px-lg-17">
													...
													<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
														...
														<!--begin::Input group-->
															...
															<!--end::Label-->
															<!--begin::Input-->
															<input type="text" autocomplete="off" class="form-control form-control-solid" placeholder="" name="location_name" id="location_name" />
															<!--end::Input-->
														    </div>
														<!--end::Input group-->
												...
												<div class="modal-footer flex-center">
													...
													<!--end::Button-->
													<!--begin::Button-->
													<button type="button" id="master_create_btn" class="btn btn-primary" name="master_create_btn" onclick="location_submit()">
		...
		$(document).ready(function() {
			...
			{					
				...
				Swal.fire({
					...
					t.value?(window.location.href = "{{ URL::to('transport') }}"):"cancel"===t.dismiss&&Swal.fire({
						text:"Your form has not been cancelled!.",
						icon:"error",
						buttonsStyling:!1,
						confirmButtonText:"Ok, got it!",
        ...
        function location_submit()
		{
				...
				var locations=$('#location_name').val();
				// alert(location);
				// return false;
				var ajax_url = "{{ URL::to('submitlocation') }}";
				$.ajax({
                    url: ajax_url,
                    type: 'POST',
                    data: {location:locations,_token:"<?php echo csrf_token(); ?>"},
                  //  contentType: false,
                  //  cache: false,
                  //  processData: false,
		...
		function ajax_submit() {
				...
				var ajax_url = "{{ URL::to('submittransport') }}";
                $("#lns-error").hide();
