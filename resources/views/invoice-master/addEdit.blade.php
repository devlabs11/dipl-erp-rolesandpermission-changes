                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-4">
											...
											<input type="text" class="form-control form-control-solid" name="full_name" id="full_name" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-4">
                                    ...
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="email" class="form-control form-control-solid" name="confirm_password" id="confirm_password" value="">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="fv-row mb-4">
                                            ...
                                            <input type="text" class="form-control form-control-solid" name="emp_code" id="">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="fv-row mb-4">
