...
-->
@php
    $create = \Helper::getPermission('jc-create') ? 1 : 1;
@endphp
<html lang="en">
	<!--begin::Head-->
	<head>
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Job Card</h1>
									<!--end::Title-->
									<!--begin::Separator-->
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									{{-- <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                        <a href="{{ route('job-card-create') }}" class="btn btn-sm btn-primary">Add Quotation</a>
								    </div> --}}
								...
								<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
									...
									<!--end::Menu-->
										<!-- <a href="{{ URL::to('jobcardaddedit/0/general') }}" class="btn btn-sm btn-primary">Add Job Card</a>&nbsp;&nbsp;
										<a href="{{ URL::to('thermal_jobcardaddedit/0/general') }}" class="btn btn-sm btn-primary">Add Thermal Job Card</a>&nbsp;&nbsp;
										<a href="{{ URL::to('computer_stationary_jobcardaddedit/0/general') }}" class="btn btn-sm btn-primary">Add Computer Stationary Job Card</a>&nbsp;&nbsp;
										<a href="{{ URL::to('checkjobcardaddedit/0/general') }}" class="btn btn-sm btn-primary">Add Check Job Card</a>
									 -->

									<!-- <a href="{{ URL::to('thermal_jobcardaddedit/0') }}" class="btn btn-sm btn-primary">Add Job Card</a>		 -->
											</div>
								...
								<!-- <div class="d-flex align-items-center gap-2 gap-lg-3"> -->
									...
									<!--begin::Secondary button-->
									<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
									<a href="#" style="margin-right:5px" class="btn btn-sm btn-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Add Job Card
									<!--begin::Svg Icon | path: icons/duotune/arrows/arr072.svg-->
									<span class="svg-icon svg-icon-5 m-0">
										<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
											<path d="M11.4343 12.7344L7.25 8.55005C6.83579 8.13583 6.16421 8.13584 5.75 8.55005C5.33579 8.96426 5.33579 9.63583 5.75 10.05L11.2929 15.5929C11.6834 15.9835 12.3166 15.9835 12.7071 15.5929L18.25 10.05C18.6642 9.63584 18.6642 8.96426 18.25 8.55005C17.8358 8.13584 17.1642 8.13584 16.75 8.55005L12.5657 12.7344C12.2533 13.0468 11.7467 13.0468 11.4343 12.7344Z" fill="black" />
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
										<!--begin::Menu item-->
										<div class="menu-item px-3">
											<!-- <a id="bulk_delete1" class="menu-link px-3">Delete11</a> -->
											<a href="{{ URL::to('jobcardaddedit/0/general') }}" class="menu-link px-3">Regular JC</a>
										</div>
										<!--end::Menu item-->
										...
										<div class="menu-item px-3">
											<!-- <a id="bulk_delete1" class="menu-link px-3">Delete11</a> -->
											<a href="{{ URL::to('thermal_jobcardaddedit/0/general') }}" class="menu-link px-3">Thermal JC</a>
										...
										<div class="menu-item px-3">
											<!-- <a id="bulk_delete1" class="menu-link px-3">Delete11</a> -->
											<a href="{{ URL::to('computer_stationary_jobcardaddedit/0/general') }}" class="menu-link px-3">Computer Stationary JC</a>
										...
										<div class="menu-item px-3">
											<!-- <a id="bulk_delete1" class="menu-link px-3">Delete11</a> -->
											<a href="{{ URL::to('checkjobcardaddedit/0/general') }}" class="menu-link px-3">Cheque JC</a>
										</div>
										<!--end::Menu item-->
									</div>
                                    @endif
								...
								<div class="card">
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												<!--begin::Add customer-->
												<button style="display:none" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Job Card</button>
												<!--end::Add customer-->
											</div>
											<!--end::Toolbar-->
											<!--begin::Group actions-->
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<thead>
													...
													<th class="w-10px pe-2">
														...
														<th>Id</th>
														<th>Job Card No</th>
														<th>Job Card Title</th>
														<th>Size</th>
														<th>Job Product Category</th>
														<th>Job Product Type</th>
														<th>Actions</th>
													</tr>
													<!--end::Table row-->
												</thead>
		...
		function LoadConfirmDialog(content,opt){
			Swal.fire({
				...
				if (result.isConfirmed) {
					...
					url : "{{ URL::to('record_actions_jobcard') }}",
