...
<body style="font-family:'Helvetica';font-size: 11.25pt;">
    ...
    <main>
        ...
        @if (isset($$product_category_name) && isset($product_type_name) && isset($job_card_no) && isset($job_card_title) && isset($company_product_no) && isset($product_name_by_customer))
            <h2>
        ...
        @else
            @if (isset($$product_category_name) || isset($product_type_name) || isset($job_card_no) || isset($job_card_title) || isset($company_product_no) || isset($product_name_by_customer))
                ...
                @if (isset($product_category_name))
                    <b><?php echo 'Product Category :'; ?></b><?php echo $product_category_name; ?><br /><br />
                @endif
                @if (isset($product_type_name))
                    <b><?php echo 'Product Type :'; ?></b><?php echo $product_type_name; ?></b><br /><br />
                @endif
                @if (isset($job_card_no))
                    <b><?php echo 'Job Card No  :'; ?></b><?php echo $job_card_no; ?></b><br /><br />
                @endif
                @if (isset($job_card_title))
                    <b><?php echo 'Job Card Title :'; ?></b><?php echo $job_card_title; ?></b><br /><br />
                @endif
                @if (isset($company_product_no))
                    <b><?php echo "Company's Product No :"; ?></b><?php echo $company_product_no; ?></b><br /><br />
                @endif
                @if (isset($product_name_by_customer))
                    <b><?php echo 'Product Name By Customer :'; ?></b><?php echo $product_name_by_customer; ?></b><br /><br />
                @endif
            @endif
        @endif
        ...
        @if (isset($general_width) && isset($general_height_length) && isset($part_ply) && isset($general_item_type))
            <b>
                <h3><?php echo 'Size'; ?></h3>
            </b>
        ...
        @else
            @if (isset($general_width) || isset($general_height_length) || isset($part_ply) || isset($general_item_type))
                ...
                @if (isset($general_width))
                    <b><?php echo 'Width :'; ?></b><?php echo $general_width . ' ' . $general_width_unit; ?><br /><br />
                @endif
                @if (isset($general_height_length))
                    <b><?php echo 'Height / Length  :'; ?></b><?php echo $general_height_length . ' ' . $genral_height_unit; ?></b><br /><br />
                @endif
                @if (isset($part_ply))
                    <b><?php echo 'Part Ply :'; ?></b><?php echo $part_ply; ?></b><br /><br />
                @endif
                @if (isset($general_item_type))
                    <b><?php echo 'Item Type :'; ?></b><?php echo $general_item_type; ?></b><br /><br />
                @endif
            @endif
        @endif
        ...
        <table id='maintable'
            ...
            <?php
				...
				foreach($tbl_job_card_paper as $tbl_job_card_paper)
				{
					...
					$back_side_color_arr = explode(",",$front_side_color);
...
else
{
	?>
        <b>
            <h3><?php echo 'Paper Thickness'; ?></h3>
        </b>
        <table id='maintable1'
            style='width:100% !important;border: 1px solid black;border-collapse: collapse;padding-top:15px;'>
            <tr>
...
else
{
	?>
        ...
        <table id='maintable1'
            ...
            <tr>
                <td colspan="5" style="text-align:center;padding-top:10px;padding-bottom:10px">No data available
                </td>
            </tr>
        </table>
        <?php
...
?>
        ...
        <br />
        <?php
$tbl_job_card_press_spare_to_use_count1 = DB::table('tbl_job_card_press_spare_to_use')->where('press_id',$press_id)->select('*')->get();
...
?>
        ...
        @if (isset($printing) && isset($coating))
            <b>
        ...
        @if (isset($collating_width) && isset($collating_type) && isset($collating_carbon_option) && isset($collating_between_ply))
            <b>
                <h3><?php echo 'Collating'; ?></h3>
            </b>
        ...
        @else
            @if (isset($collating_width) || isset($collating_type) || isset($collating_carbon_option) || isset($collating_between_ply))
                ...
                @if (isset($collating_width))
                    <b><?php echo 'Width :'; ?></b><?php echo $collating_width; ?><br /><br />
                @endif
                @if (isset($collating_type))
                    <b><?php echo 'Type :'; ?></b><?php echo $collating_type; ?><br /><br />
                @endif
                @if (isset($collating_carbon_option))
                    <b><?php echo 'Carbon Option:'; ?></b><?php echo $collating_carbon_option; ?><br /><br />
                @endif
                @if (isset($collating_between_ply))
                    <b><?php echo 'Collating between Ply:'; ?></b><?php echo $collating_between_ply; ?><br /><br />
                @endif
            @endif
        @endif
        ...
        @if (isset($numbering_position) && isset($numbering_style) && isset($numbering_skip) && isset($numbering_sequence) && isset($numbering_orientation))
            <b>
        ...
        @else
            @if (isset($numbering_position) || isset($numbering_style) || isset($numbering_skip) || isset($numbering_sequence) || isset($numbering_orientation))
                ...
                @if (isset($numbering_position))
                    <b><?php echo 'Position :'; ?></b><?php echo $numbering_position; ?><br /><br />
                @endif
                @if (isset($numbering_style))
                    <b><?php echo 'Style :'; ?></b><?php echo $numbering_style; ?><br /><br />
                @endif
                @if (isset($numbering_skip))
                    <b><?php echo 'Skips :'; ?></b><?php echo $numbering_skip; ?><br /><br />
                @endif
                @if (isset($numbering_sequence))
                    <b><?php echo 'Sequence :'; ?></b><?php echo $numbering_sequence; ?><br /><br />
                @endif
                @if (isset($numbering_orientation))
                    <b><?php echo 'Orientation :'; ?></b><?php echo $numbering_orientation; ?><br /><br />
                @endif
            @endif
        @endif

        @if (isset($gumming_position) && isset($gumming_gum_make) && isset($gumming_quantity) && isset($gumming_between))
            <b>
        ...
        @else
            @if (isset($gumming_position) || isset($numbering_style) || isset($gumming_quantity) || isset($gumming_between))
                <b>
                    <h3><?php echo 'Gumming Details '; ?></h3>
                </b>
                @if (isset($gumming_position))
                    <b><?php echo 'Position :'; ?></b><?php echo $gumming_position; ?><br /><br />
                @endif
                @if (isset($gumming_gum_make))
                    <b><?php echo 'Gum Make  :'; ?></b><?php echo $gumming_gum_make; ?><br /><br />
                @endif
                @if (isset($gumming_quantity))
                    <b><?php echo 'Quantity (Per 1000 Prints)  :'; ?></b><?php echo $gumming_quantity; ?><br /><br />
                @endif
                @if (isset($gumming_between))
                    <b><?php echo 'Gumming between :'; ?></b><?php echo $gumming_between; ?><br /><br />
                @endif
            @endif
        @endif
...
$tbl_job_card_post_press_packaging_details_count1 = DB::table('tbl_job_card_post_press_packaging_details')->where('job_card_id',$jobcard_id)->select('*')->get();
...
?>
        ...
        <br />
        @if (isset($hotspot_carbon_width) && isset($hotspot_carbon_height) && isset($hotspot_carbon_behind_ply_no))
            <b>
        ...
        @else
            @if (isset($hotspot_carbon_width) || isset($hotspot_carbon_height) || ($hotspot_carbon_behind_ply_no && isset($hotspot_carbon_behind_ply_no)))
                <b>
                    <h3><?php echo 'Hotspot Carbon '; ?></h3>
                </b>

                @if (isset($hotspot_carbon_width))
                    <b><?php echo 'Width :'; ?></b><?php echo $hotspot_carbon_width; ?><br /><br />
                @endif
                @if (isset($hotspot_carbon_height))
                    <b><?php echo 'Height :'; ?></b><?php echo $hotspot_carbon_height; ?><br /><br />
                @endif
                @if (isset($hotspot_carbon_behind_ply_no) && $hotspot_carbon_behind_ply_no)
                    <b><?php echo 'Carbon behind ply no :'; ?></b><?php echo $hotspot_carbon_behind_ply_no; ?><br /><br />
                @endif
            @endif
        @endif
        ...
        @if (isset($cutting_width) && isset($cutting_length) && isset($cutting_core_size))
            <b>
        ...
        @else
            @if (isset($cutting_width) || isset($cutting_length) || isset($cutting_core_size))
                ...
                @if (isset($cutting_width))
                    <b><?php echo 'Width :'; ?></b><?php echo $cutting_width . ' ' . $cutting_width_unit; ?><br /><br />
                @endif
                @if (isset($cutting_length))
                    <b><?php echo 'Length :'; ?></b><?php echo $cutting_length . ' ' . $cutting_length_unit; ?><br /><br />
                @endif
                @if (isset($cutting_core_size))
                    <b><?php echo 'Core size(diameter) :'; ?></b><?php echo $cutting_core_size; ?><br /><br />
                @endif
        ...
        @if (isset($barcode_type) && isset($barcode_height) && isset($barcode_width) && isset($barcode_orientation) && isset($barcode_human_readable_text_to_show))
            <b>
        ...
        @isset($baby_roll_making_coating_side)
            <b>
