...
@section('content')
@php
    $create = \Helper::getPermission('jc-type-m-create') ? 1 : 0;
    $edit = \Helper::getPermission('jc-type-m-edit') ? 1 : 0;
    $delete = \Helper::getPermission('jc-type-m-delete') ? 1 : 0;
@endphp
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Job Card Type</h1>
                <!--end::Title-->
            </div>
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                    {{-- <a href="{{route('job-card-type-create') }}" class="btn btn-sm btn-primary">Add Product Size</a> --}}
					{{-- <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Job Card Type</button> --}}
                    @if ($create == 1)
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">Add Job Card Type</h3>
