                                ...
                                <div class="row row-cols-1 row-cols-sm-3 rol-cols-md-1 row-cols-lg-3">
                                    <div class="col">
                                        <div class="fv-row mb-2">
                                            ...
                                            <input type="number" name="sgst" id="sgst" class="form-control form-control-solid">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="fv-row mb-2">
                                            ...
                                            <input type="number" name="cgst" id="cgst" class="form-control form-control-solid">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="fv-row mb-2">
                                            ...
                                            <input type="number" name="igst" id="igst" class="form-control form-control-solid">
                                        </div>
                                    </div>
