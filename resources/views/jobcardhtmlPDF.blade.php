...
<body style="font-family:'Helvetica';font-size: 11.25pt;">
    ...
    <main>
        ...
        @if (!empty($$product_category_name) && !empty($product_type_name) && !empty($job_card_no) && !empty($job_card_title) && !empty($company_product_no) && !empty($product_name_by_customer))
            <h2>
                <center><u>General Details</u></center>
            </h2>
        ...
        @else
            @if (!empty($$product_category_name) || !empty($product_type_name) || !empty($job_card_no) || !empty($job_card_title) || !empty($company_product_no) || !empty($product_name_by_customer))
                ...
                @if (!empty($product_type_name))
                    <b><?php echo 'Product Type :'; ?></b><?php echo $product_type_name; ?></b><br /><br />
                @endif
                @if (!empty($job_card_no))
                    <b><?php echo 'Job Card No  :'; ?></b><?php echo $job_card_no; ?></b><br /><br />
                @endif
                @if (!empty($job_card_title))
                    <b><?php echo 'Job Card Title :'; ?></b><?php echo $job_card_title; ?></b><br /><br />
                @endif
                @if (!empty($company_product_no))
                    <b><?php echo "Company's Product No :"; ?></b><?php echo $company_product_no; ?></b><br /><br />
                @endif
                @if (!empty($product_name_by_customer))
                    <b><?php echo 'Product Name By Customer :'; ?></b><?php echo $product_name_by_customer; ?></b><br /><br />
                @endif
            @endif
        @endif
        ...
        @if (!empty($general_width) && !empty($general_height_length) && !empty($part_ply) && !empty($general_item_type))
            <b>
                <h3><?php echo 'Size'; ?></h3>
            </b>
        ...
        @else
            @if (!empty($general_width) || !empty($general_height_length) || !empty($part_ply) || !empty($general_item_type))
                ...
                @if (!empty($general_width))
                    <b><?php echo 'Width :'; ?></b><?php echo $general_width . ' ' . $general_width_unit; ?><br /><br />
                @endif
                @if (!empty($general_height_length))
                    <b><?php echo 'Height / Length  :'; ?></b><?php echo $general_height_length . ' ' . $genral_height_unit; ?></b><br /><br />
                @endif
                @if (!empty($part_ply))
                    <b><?php echo 'Part Ply :'; ?></b><?php echo $part_ply; ?></b><br /><br />
                @endif
                @if (!empty($general_item_type))
                    <b><?php echo 'Item Type :'; ?></b><?php echo $general_item_type; ?></b><br /><br />
                @endif
            @endif
        @endif
        ...
        <?php
			$tbl_job_card_paper_count = DB::table('tbl_job_card_paper')->where('job_card_id',$jobcard_id)->get();
            // DB::select("select count(*) as totalcount from tbl_job_card_paper where job_card_id='".$jobcard_id."'");
			...
			if(count($tbl_job_card_paper_count) > 0)
			{
				?>
        {{-- @if (count($tbl_job_card_paper_count) > 0)
        ...
        <table id='maintable'
            ...
            <tr>
                <th
                    style="text-align:left;border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    Paper Thick</th>
                    <th
                    style="text-align:left;border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                   Paper Size</th>
            ...
            <tr>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $paper_thick; ?></td>

                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                {{$paper_width}} {{$paper_unit_name}}</td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $paper_make_name; ?></td>

                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $mst_color_shade_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $front_side_color_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $back_side_color_name; ?></td>
                {{-- <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $front_side_coating_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $back_side_coating_name; ?></td> --}}
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $copy_mark; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $remark; ?></td>
            </tr>
            <?php
        ...
        <p>
            ...
            @endif
            @if (!empty($perforation))
                <b><?php echo 'Perforation :'; ?></b><?php echo $perforation; ?><br />
            @endif
        </p>

        <?php
            $tbl_job_card_position_count = DB::table('tbl_job_card_position')->where('job_card_id',$jobcard_id)->get();
            //  DB::select("select count(*) as totalcount from tbl_job_card_position where job_card_id='".$jobcard_id."'");
            ...
            if(count($tbl_job_card_position_count) > 0)
            {
            ?>
        <table id='maintable1'
            style='width:100% !important;border: 1px solid black;border-collapse: collapse;padding-top:15px;'>
...
?>
        ...
        @if (!empty($columns) && !empty($rows) && !empty($length) && !empty($width) && !empty($thickness))
            <h2>
                <center><u>Pre Press Details</u></center>
            </h2>
            <b>
                <h3><?php echo 'Printing Ups'; ?></h3>
            </b>
            <b><?php echo 'Columns :'; ?></b><?php echo $columns; ?><br /><br />
            <b><?php echo 'Rows :'; ?></b><?php echo $rows; ?><br /><br />
            <b>
                <h3><?php echo 'Size of Plates'; ?></h3>
            </b>
        ...
        @else
            ...
            <h2>
                ...
                @if (!empty($length) || !empty($width) || !empty( $thickness))
                    <b>
                        <h3><?php echo 'Size of Plates'; ?></h3>
                    </b>
                    @if (!empty($length))
...
$tbl_job_card_pre_press_color_count = DB::table('tbl_job_card_pre_press_color')->where('pre_press_id',$pre_press_id)->get();
// select("select count(*) as totalcount from tbl_job_card_pre_press_color where pre_press_id='".$pre_press_id."'");
...
if(count($tbl_job_card_pre_press_color_count) > 0)
{
?>

        <b>
            <h3><?php echo 'Colour Details'; ?></h3>
        </b>
        <table id='maintable1'
            style='width:100% !important;border: 1px solid black;border-collapse: collapse;padding-top:15px;'>
            <tr>
	...
	?>
            <tr>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $color_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $film_type_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $ply; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $plate_type_name; ?></td>
            </tr>
            <?php
	}
	?>
...
$tbl_job_card_press_paper_count = DB::table('tbl_job_card_press_paper')->where('press_id',$press_id)->get();
// DB::select("select count(*) as totalcount from tbl_job_card_press_paper where press_id='".$press_id."'");
...
//echo $job_card_paper_count;die;
if(count($tbl_job_card_press_paper_count)>0)
{
?>
<h2>
    <center><u>Press Details</u></center>
</h2>
        <b>
            <h3><?php echo 'Paper Details'; ?></h3>
        </b>
        <table id='maintable1'
            style='width:100% !important;border: 1px solid black;border-collapse: collapse;padding-top:15px;'>
            <tr>
	...
	?>
            <tr>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $paper_thickness_proposed; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $gsm_make_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $paper_thickness_used; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $unit; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
...
$tbl_job_card_press_ink_details_count = DB::table('tbl_job_card_press_ink_details')->where('press_id',$press_id)->get();
// DB::select("select count(*) as totalcount from tbl_job_card_press_ink_details where press_id='".$press_id."'");
//var_dump($tbl_job_card_material_requirement_count);die;
...
//echo $job_card_material_requirement_count;die;
if(count($tbl_job_card_press_ink_details_count)>0)
{
?>

        <b>
            <h3><?php echo 'Ink Details'; ?></h3>
        </b>
        <table id='maintable1'
            style='width:100% !important;border: 1px solid black;border-collapse: collapse;padding-top:15px;'>
            <tr>
	...
	?>
            <tr>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $ink_color; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $ink_shade_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $ink_company_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $ink_quantity; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $ink_units_name; ?></td>
...
?>
        ...
        <br />
        <?php
        $job_card_press_spare_to_use_count="";
        $tbl_job_card_press_spare_to_use_count = DB::table('tbl_job_card_press_spare_to_use')->where('press_id',$press_id)->select('*')->get();
...
// foreach($tbl_job_card_press_spare_to_use_count1 as $tbl_job_card_press_spare_to_use_count)
// {
// 	//var_dump($tbl_plants_count);die;
// 	$job_card_press_spare_to_use_count=$tbl_job_card_press_spare_to_use_count->spare;
// }

//echo $job_card_paper_count;die;

if(count($tbl_job_card_press_spare_to_use_count) > 0)
{
?>

        <b>
            <h3><?php echo 'Spares to Use'; ?></h3>
        </b>
        <table id='maintable1'
            style='width:100% !important;border: 1px solid black;border-collapse: collapse;padding-top:15px;'>
            <tr>
...
?>
        ...
        @if (!empty($printing) && !empty($coating))
            <b>
                <h3><?php echo 'Coating Details'; ?></h3>
            </b>
        ...
        @if (!empty($collating_width) && !empty($collating_type) && !empty($collating_carbon_option) && !empty($collating_between_ply))
            <h2>
                <center><u>Post Press Details</u></center>
            </h2>
            <b>
                <h3><?php echo 'Collating'; ?></h3>
            </b>
        ...
        @else
            ...
            <h2>
                ...
                @if (!empty($collating_width))
                    <b><?php echo 'Width :'; ?></b><?php echo $collating_width; ?><br /><br />
                @endif
                @if (!empty($collating_type))
                    <b><?php echo 'Type :'; ?></b><?php echo $collating_type; ?><br /><br />
                @endif
                @if (!empty($collating_carbon_option))
                    <b><?php echo 'Carbon Option:'; ?></b><?php echo $collating_carbon_option; ?><br /><br />
                @endif
                @if (!empty($collating_between_ply))
                    <b><?php echo 'Collating between Ply:'; ?></b><?php echo $collating_between_ply; ?><br /><br />
                @endif
            @endif
        @endif
        ...
        @if (!empty($numbering_position) && !empty($numbering_style) && !empty($numbering_skip) && !empty($numbering_sequence) && !empty($numbering_orientation))
            <b>
                <h3><?php echo 'Numbering'; ?></h3>
            </b>
        ...
        @else
            @if (!empty($numbering_position) || !empty($numbering_style) || !empty($numbering_skip) || !empty($numbering_sequence) || !empty($numbering_orientation))
                ...
                @if (!empty($numbering_position))
                    <b><?php echo 'Position :'; ?></b><?php echo $numbering_position; ?><br /><br />
                @endif
                @if (!empty($numbering_style))
                    <b><?php echo 'Style :'; ?></b><?php echo $numbering_style; ?><br /><br />
                @endif
                @if (!empty($numbering_skip))
                    <b><?php echo 'Skips :'; ?></b><?php echo $numbering_skip; ?><br /><br />
                @endif
                @if (!empty($numbering_sequence))
                    <b><?php echo 'Sequence :'; ?></b><?php echo $numbering_sequence; ?><br /><br />
                @endif
                @if (!empty($numbering_orientation))
                    <b><?php echo 'Orientation :'; ?></b><?php echo $numbering_orientation; ?><br /><br />
                @endif
            @endif
        @endif

        @if (!empty($gumming_position) && !empty($gumming_gum_make) && !empty($gumming_quantity) && !empty($gumming_between))
            <b>
                <h3><?php echo 'Gumming Details '; ?></h3>
            </b>
        ...
        @else
            @if (!empty($gumming_position) || !empty($numbering_style) || !empty($gumming_quantity) || !empty($gumming_between))
                <b>
                    <h3><?php echo 'Gumming Details '; ?></h3>
                </b>
                @if (!empty($gumming_position))
                    <b><?php echo 'Position :'; ?></b><?php echo $gumming_position; ?><br /><br />
                @endif
                @if (!empty($gumming_gum_make))
                    <b><?php echo 'Gum Make  :'; ?></b><?php echo $gumming_gum_make; ?><br /><br />
                @endif
                @if (!empty($gumming_quantity))
                    <b><?php echo 'Quantity (Per 1000 Prints)  :'; ?></b><?php echo $gumming_quantity; ?><br /><br />
                @endif
                @if (!empty($gumming_between))
                    <b><?php echo 'Gumming between :'; ?></b><?php echo $gumming_between; ?><br /><br />
                @endif
            @endif
        @endif
...
$tbl_job_card_post_press_packaging_details_count = DB::table('tbl_job_card_post_press_packaging_details')->where('job_card_id',$jobcard_id)->select('*')->get();
//
//  DB::select("select count(*) as totalcount,item from tbl_job_card_post_press_packaging_details where job_card_id='".$jobcard_id."'");
// echo "select count(*) as totalcount from tbl_job_card_post_press_packaging_details where job_card_id='".$jobcard_id."'";
// dd(count($tbl_job_card_post_press_packaging_details_count1));
// foreach($tbl_job_card_post_press_packaging_details_count1 as $tbl_job_card_post_press_packaging_details_count)
// {
// 	//var_dump($tbl_plants_count);die;
// 	$job_card_post_press_packaging_details_count= $tbl_job_card_post_press_packaging_details_count->pcs;
//     // $checkPcs = $tbl_job_card_post_press_packaging_details_count->PCS;
// }

//echo $job_card_paper_count;die;
if(count($tbl_job_card_post_press_packaging_details_count)>0)
{
?>

        <b>
            <h3><?php echo 'Packaging Details'; ?></h3>
        </b>
        <table id='maintable1'
            style='width:100% !important;border: 1px solid black;border-collapse: collapse;padding-top:15px;'>
            <tr>
...
?>
        ...
        <br />
        @if (!empty($hotspot_carbon_width) && !empty($hotspot_carbon_height) && !empty($hotspot_carbon_behind_ply_no))
            <b>
                <h3><?php echo 'Hotspot Carbon '; ?></h3>
            </b>
        ...
        @else
            @if (!empty($hotspot_carbon_width) || !empty($hotspot_carbon_height) || ($hotspot_carbon_behind_ply_no && !empty($hotspot_carbon_behind_ply_no)))
                <b>
                    <h3><?php echo 'Hotspot Carbon '; ?></h3>
                </b>

                @if (!empty($hotspot_carbon_width))
                    <b><?php echo 'Width :'; ?></b><?php echo $hotspot_carbon_width; ?><br /><br />
                @endif
                @if (!empty($hotspot_carbon_height))
                    <b><?php echo 'Height :'; ?></b><?php echo $hotspot_carbon_height; ?><br /><br />
                @endif
                @if (!empty($hotspot_carbon_behind_ply_no) && $hotspot_carbon_behind_ply_no)
                    <b><?php echo 'Carbon behind ply no :'; ?></b><?php echo $hotspot_carbon_behind_ply_no; ?><br /><br />
                @endif
            @endif
        @endif
        ...
        @if (!empty($cutting_width) && !empty($cutting_length) && !empty($cutting_core_size))
            <b>
                <h3><?php echo 'Cutting '; ?></h3>
            </b>

            <b><?php echo 'Width :'; ?></b><?php echo $cutting_width . ' ' . $cutting_width_unit; ?><br /><br />
            <b><?php echo 'Length :'; ?></b><?php echo $cutting_length . ' ' . $cutting_length_unit; ?><br /><br />
            <b><?php echo 'Core size(diameter) :'; ?></b><?php echo $cutting_core_size; ?><br /><br />
        @else
            @if (!empty($cutting_width) || !empty($cutting_length) || !empty($cutting_core_size))
                <b>
                    <h3><?php echo 'Cutting '; ?></h3>
                </b>
                @if (!empty($cutting_width))
                    <b><?php echo 'Width :'; ?></b><?php echo $cutting_width . ' ' . $cutting_width_unit; ?><br /><br />
                @endif
                @if (!empty($cutting_length))
                    <b><?php echo 'Length :'; ?></b><?php echo $cutting_length . ' ' . $cutting_length_unit; ?><br /><br />
                @endif
                @if (!empty($cutting_core_size))
                    <b><?php echo 'Core size(diameter) :'; ?></b><?php echo $cutting_core_size; ?><br /><br />
                @endif
        ...
        @if (!empty($barcode_type) && !empty($barcode_height) && !empty($barcode_width) && !empty($barcode_orientation) && !empty($barcode_human_readable_text_to_show))
            <b>
                <h3><?php echo 'Barcode'; ?></h3>
            </b>

            <b><?php echo 'Type :'; ?></b><?php echo $barcode_type; ?><br /><br />
            <b><?php echo 'Height :'; ?></b><?php echo $barcode_height; ?><br /><br />
            <b><?php echo 'Width :'; ?></b><?php echo $barcode_width; ?><br /><br />
            <b><?php echo 'Orientation :'; ?></b><?php echo $barcode_orientation; ?><br /><br />
            <b><?php echo 'Human readable text to show? :'; ?></b><?php echo $barcode_human_readable_text_to_show; ?><br /><br />
        @else
            @if (!empty($barcode_type) || !empty($barcode_height) || !empty($barcode_width) || !empty($barcode_orientation) || !empty($barcode_human_readable_text_to_show))
                <b>
                    <h3><?php echo 'Barcode '; ?></h3>
                ...
                @if (!empty($barcode_height))
                    <b><?php echo 'Height :'; ?></b><?php echo $barcode_height; ?><br /><br />
                @endif
                @if (!empty($barcode_width))
                    <b><?php echo 'Width :'; ?></b><?php echo $barcode_width; ?><br /><br />
                @endif
                @if (!empty($barcode_orientation))
                    <b><?php echo 'Orientation :'; ?></b><?php echo $barcode_orientation; ?><br /><br />
                @endif
                @if (!empty($barcode_human_readable_text_to_show))
                    <b><?php echo 'Human readable text to show? :'; ?></b><?php echo $barcode_human_readable_text_to_show; ?><br /><br />
                @endif
            @endif
        @endif

        @if(!empty($baby_roll_making_coating_side))
            <b>
                <h3><?php echo 'Baby Roll Making '; ?></h3>
            </b>

            <b><?php echo 'Coating Side :'; ?></b><?php echo $baby_roll_making_coating_side; ?><br /><br />
        @endif
...
<h2>
    <center><u>Process Selection</u></center>
</h2>
...
<br />
	...
	?>
            <tr>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $process_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $basicmachine_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $alternativemachine_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $qc_name; ?></td>
...
<h2>
    <center><u>Material Requirement</u></center>
</h2>
<!-- Material Requirement -->
<br />

        <b>
            <h3><?php echo 'Material Requirement'; ?></h3>
        </b>
        <table id='maintable1'
            style='width:100% !important;border: 1px solid black;border-collapse: collapse;padding-top:15px;'>
            <tr>
	...
	?>
            <tr>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $rm_category_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $type_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $rm_item_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $quantity; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $units_name; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $wastage_allowed; ?></td>
                <td style="border: 1px solid black;border-collapse: collapse;padding: 5px;vertical-align:top;">
                    <?php echo $pcs; ?></td>
