<!DOCTYPE html>
@php
    $create = \Helper::getPermission('company-create') ? 1 : 0;
@endphp
<html lang="en">
	<!--begin::Head-->
	<head>
						...
						<div class="toolbar" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									<!--begin::Title-->
									<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Company</h1>
									<!--end::Title-->
									<!--begin::Separator-->
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                        ...
                                        @if($create == 1)
										    <a href="{{ URL::to('companyaddedit/0') }}" class="btn btn-sm btn-primary">Add Company</a>
                                        @endif
									</div>
								...
								<div class="card">
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                                ...
                                                @if($create)
												<!--begin::Add customer-->
												<button style="display:none" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_customer">Add Company</button>
                                                @endif
												<!--end::Add customer-->
											</div>
											<!--end::Toolbar-->
									...
									<div class="card-body pt-0">
										...
										<form id="master_frm" name="master_frm" method="post">
											...
											<!--begin::Table-->
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table" style="width:100%;">
												<!--begin::Table head-->
												...
												<!--end::Table head-->
												<!--begin::Table body-->
												<tbody class="fw-bold text-gray-600" style="width:100%;">
				...
				function datatablerefresh()
				{
					var table=$('#kt_customers_table').DataTable({
						...
						"columnDefs": [
							...
							{'orderable': true,'searchable': false,'targets': [1],'width':'30%'},
							{'orderable': true,'searchable': false,'targets': [2],'width':'30%'},
							{'orderable': true,'searchable': false,'targets': [3],'width':'30%'},
			...
			Swal.fire({
						...
						//denyButtonText: `Don't save`,
							...
							if (result.isConfirmed) {
                                ...
                                url : "{{ URL::to('record_actions_company') }}",
        						//data : {'token' : 123},
                                success: function (response_json) {
									var response= JSON.parse(response_json);
